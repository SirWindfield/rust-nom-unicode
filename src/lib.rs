...
mod tests {
    ...
    fn call<T, F>(f: F, input: T) -> IResult<T, T>
    where
    ...
    fn alpha0_complete_test() {
        run_tests(
            ...
            &[
                ...
                ("\u{200b}", Ok(("\u{200b}", ""))),
                (
                    "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                    Ok((
                        "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                        "",
                    )),
    ...
    fn alpha1_complete_test() {
        run_tests(
            ...
            &[
                ...
                (
                    " \t\n\x08",
                    Err(Error(NomError::new(" \t\n\x08", ErrorKind::Alpha))),
                ),
                (
                    "\u{200b}",
                    Err(Error(NomError::new("\u{200b}", ErrorKind::Alpha))),
                ),
                (
                    "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                    Err(Error(NomError::new(
                ...
                (
                    "\x00\x01\x02\u{80}",
                    Err(Error(NomError::new("\x00\x01\x02\u{80}", ErrorKind::Alpha))),
                ),
                (
                    "\u{94}\u{100}",
                    Err(Error(NomError::new("\u{94}\u{100}", ErrorKind::Alpha))),
                ),
    ...
    fn lower1_complete_test() {
        run_tests(
            ...
            &[
                ...
                (
                    "LATIN",
                    Err(Error(NomError::new("LATIN", ErrorKind::Alpha))),
                ),
                (
                    "LATIN123",
                    Err(Error(NomError::new("LATIN123", ErrorKind::Alpha))),
                ),
                ("123", Err(Error(NomError::new("123", ErrorKind::Alpha)))),
                ("erfüllen", Ok(("", "erfüllen"))),
                ("erfüllen123", Ok(("123", "erfüllen"))),
                (
                    "조선글",
                    Err(Error(NomError::new("조선글", ErrorKind::Alpha))),
                ),
                (
                    "조선글123",
                    Err(Error(NomError::new("조선글123", ErrorKind::Alpha))),
                ),
                (
                    " \t\n\x08",
                    Err(Error(NomError::new(" \t\n\x08", ErrorKind::Alpha))),
    ...
    fn upper1_complete_test() {
        run_tests(
            ...
            &[
                ...
                (
                    "erfüllen",
                    Err(Error(NomError::new("erfüllen", ErrorKind::Alpha))),
                ),
                (
                    "erfüllen123",
                    Err(Error(NomError::new("erfüllen123", ErrorKind::Alpha))),
                ),
                (
                    "조선글",
                    Err(Error(NomError::new("조선글", ErrorKind::Alpha))),
        ...
        run_tests(
            ...
            &[
                ...
                (
                    ...
                    Ok((
                        "\u{200b}",
                        "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}",
                    )),
                ),
                ("\x00\x01\x02\u{80}", Ok(("\x00\x01\x02\u{80}", ""))),
                ("\u{94}\u{100}", Ok(("\u{94}\u{100}", ""))),
    ...
    fn space1_complete_test() {
        run_tests(
            ...
            &[
                (
                    "latin",
                    Err(Error(NomError::new("latin", ErrorKind::Space))),
                ),
                (
                    "latin123",
                    Err(Error(NomError::new("latin123", ErrorKind::Space))),
                ),
                (
                    "LATIN",
                    Err(Error(NomError::new("LATIN", ErrorKind::Space))),
                ...
                (
                    "erfüllen",
                    Err(Error(NomError::new("erfüllen", ErrorKind::Space))),
                ),
                (
                    "erfüllen123",
                    Err(Error(NomError::new("erfüllen123", ErrorKind::Space))),
                ),
                (
                    "조선글",
                    Err(Error(NomError::new("조선글", ErrorKind::Space))),
                ),
                (
                    "조선글123",
                    Err(Error(NomError::new("조선글123", ErrorKind::Space))),
                ),
                (" \t\n\x08", Ok(("\x08", " \t\n"))),
                (
                    "\u{200b}",
                    Err(Error(NomError::new("\u{200b}", ErrorKind::Space))),
                ),
                (
                    "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                    Ok((
                ...
                (
                    "\x00\x01\x02\u{80}",
                    Err(Error(NomError::new("\x00\x01\x02\u{80}", ErrorKind::Space))),
                ),
                (
                    "\u{94}\u{100}",
                    Err(Error(NomError::new("\u{94}\u{100}", ErrorKind::Space))),
                ),
    ...
    fn alphanumeric1_complete_test() {
        run_tests(
            ...
            &[
                ...
                (
                    "\u{200b}",
                    Err(Error(NomError::new("\u{200b}", ErrorKind::AlphaNumeric))),
                ),
                (
                    "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                    Err(Error(NomError::new(
    ...
    fn control1_complete_test() {
        run_tests(
            ...
            &[
                (
                    "latin",
                    Err(Error(NomError::new("latin", ErrorKind::TakeWhile1))),
                ),
                (
                    "latin123",
                    Err(Error(NomError::new("latin123", ErrorKind::TakeWhile1))),
                ),
                (
                    "LATIN",
                    Err(Error(NomError::new("LATIN", ErrorKind::TakeWhile1))),
                ...
                (
                    "123",
                    Err(Error(NomError::new("123", ErrorKind::TakeWhile1))),
                ),
                (
                    "erfüllen",
                    Err(Error(NomError::new("erfüllen", ErrorKind::TakeWhile1))),
                ),
                (
                    "erfüllen123",
                    Err(Error(NomError::new("erfüllen123", ErrorKind::TakeWhile1))),
                ),
                (
                    "조선글",
                    Err(Error(NomError::new("조선글", ErrorKind::TakeWhile1))),
                ),
                (
                    "조선글123",
                    Err(Error(NomError::new("조선글123", ErrorKind::TakeWhile1))),
                ),
                (
                    " \t\n\x08",
                ...
                (
                    "\u{200b}",
                    Err(Error(NomError::new("\u{200b}", ErrorKind::TakeWhile1))),
                ),
                (
                    "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                    Err(Error(NomError::new(
    ...
    fn digit1_complete_test() {
        run_tests(
            ...
            &[
                (
                    "latin",
                    Err(Error(NomError::new("latin", ErrorKind::Digit))),
                ),
                (
                    "latin123",
                    Err(Error(NomError::new("latin123", ErrorKind::Digit))),
                ),
                (
                    "LATIN",
                    Err(Error(NomError::new("LATIN", ErrorKind::Digit))),
                ...
                (
                    "erfüllen",
                    Err(Error(NomError::new("erfüllen", ErrorKind::Digit))),
                ),
                (
                    "erfüllen123",
                    Err(Error(NomError::new("erfüllen123", ErrorKind::Digit))),
                ),
                (
                    "조선글",
                    Err(Error(NomError::new("조선글", ErrorKind::Digit))),
                ),
                (
                    "조선글123",
                    Err(Error(NomError::new("조선글123", ErrorKind::Digit))),
                ),
                (
                    " \t\n\x08",
                    Err(Error(NomError::new(" \t\n\x08", ErrorKind::Digit))),
                ...
                (
                    "\u{200b}",
                    Err(Error(NomError::new("\u{200b}", ErrorKind::Digit))),
                ),
                (
                    "\u{1680}\u{200a}\u{2028}\u{202f}\u{205f}\u{3000}\u{200b}",
                    Err(Error(NomError::new(
                ...
                (
                    "\x00\x01\x02\u{80}",
                    Err(Error(NomError::new("\x00\x01\x02\u{80}", ErrorKind::Digit))),
                ),
                (
                    "\u{94}\u{100}",
                    Err(Error(NomError::new("\u{94}\u{100}", ErrorKind::Digit))),
                ),
    ...
    fn ascii1_complete_test() {
        run_tests(
            ...
            &[
                ...
                (
                    "\u{94}\u{100}",
                    Err(Error(NomError::new("\u{94}\u{100}", ErrorKind::TakeWhile1))),
                ),
                ("", Err(Error(NomError::new("", ErrorKind::TakeWhile1)))),
            ],
        );
